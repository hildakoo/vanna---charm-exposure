...
symbol = "SPY"          # ou "SPX"
risk_free_rate = 0.05
exp_index = 0           # expiration la plus proche (0DTE)
contract_size = 100     # SPY = 100 actions / SPX = multiplier 100
...
def charm(S, K, T, r, sigma, option_type):
    ...
    # Charm = variation du delta par rapport au temps (delta decay)
    if option_type == "call":
