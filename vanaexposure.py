...
print(f"\n✅ Total VEX (dealer exposure) pour {exp_date} : {VEX_total:,.0f}")
...
print(f"🟢 Peak VEX + (AIMANT / bullish) : {peak_vex_pos['VEX']:,.0f}  sur strike {peak_vex_pos['strike']}")
print(f"🔴 Peak VEX - (MUR / bearish)   : {peak_vex_neg['VEX']:,.0f}  sur strike {peak_vex_neg['strike']}")
